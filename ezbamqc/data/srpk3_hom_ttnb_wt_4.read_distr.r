png("/rds/user/is460/hpc-work/muscle-rnaseq/ezbamqc/output/figs/srpk3_hom_ttnb_wt_4.read_distr.png",width=500,height=500,units="px")
M=c(10364733,235035,2402193,1082987,53565,377841,1686,1485536)
