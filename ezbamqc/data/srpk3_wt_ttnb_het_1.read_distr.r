png("/rds/user/is460/hpc-work/muscle-rnaseq/ezbamqc/output/figs/srpk3_wt_ttnb_het_1.read_distr.png",width=500,height=500,units="px")
M=c(10708763,220864,2389189,1090757,52263,375548,1812,1442527)
