png("/rds/user/is460/hpc-work/muscle-rnaseq/ezbamqc/output/figs/srpk3_wt_ttnb_wt_2.read_distr.png",width=500,height=500,units="px")
M=c(9432525,202633,2098945,985018,47086,332498,1117,1291136)
