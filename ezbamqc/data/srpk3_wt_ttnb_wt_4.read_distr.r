png("/rds/user/is460/hpc-work/muscle-rnaseq/ezbamqc/output/figs/srpk3_wt_ttnb_wt_4.read_distr.png",width=500,height=500,units="px")
M=c(16053434,376403,3676135,1670690,86637,584746,1724,2225025)
