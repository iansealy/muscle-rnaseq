png("/rds/user/is460/hpc-work/muscle-rnaseq/ezbamqc/output/figs/srpk3_hom_ttnb_wt_8.read_distr.png",width=500,height=500,units="px")
M=c(8821997,200504,2017430,936702,45199,323468,1324,1244581)
