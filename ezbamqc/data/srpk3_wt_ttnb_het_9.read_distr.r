png("/rds/user/is460/hpc-work/muscle-rnaseq/ezbamqc/output/figs/srpk3_wt_ttnb_het_9.read_distr.png",width=500,height=500,units="px")
M=c(15094748,328767,3505245,1550927,72708,543063,2678,2102325)
