png("/rds/user/is460/hpc-work/muscle-rnaseq/ezbamqc/output/figs/srpk3_hom_ttnb_wt_1.read_distr.png",width=500,height=500,units="px")
M=c(11578597,241704,2561195,1172002,56814,400233,2212,1545887)
