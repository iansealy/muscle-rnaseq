png("/rds/user/is460/hpc-work/muscle-rnaseq/ezbamqc/output/figs/srpk3_hom_ttnb_het_1.read_distr.png",width=500,height=500,units="px")
M=c(9848992,221740,2216576,1030391,50549,357087,1383,1377946)
