png("/rds/user/is460/hpc-work/muscle-rnaseq/ezbamqc/output/figs/srpk3_hom_ttnb_het_2.read_distr.png",width=500,height=500,units="px")
M=c(14536868,322156,3283415,1436126,70572,498608,2456,1897080)
