png("/rds/user/is460/hpc-work/muscle-rnaseq/ezbamqc/output/figs/srpk3_wt_ttnb_het_7.read_distr.png",width=500,height=500,units="px")
M=c(14605855,290718,3872718,1372197,68252,507325,1389,1988573)
