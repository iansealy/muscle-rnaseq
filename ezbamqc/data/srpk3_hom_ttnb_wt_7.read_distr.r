png("/rds/user/is460/hpc-work/muscle-rnaseq/ezbamqc/output/figs/srpk3_hom_ttnb_wt_7.read_distr.png",width=500,height=500,units="px")
M=c(11772446,274103,2645537,1237936,61950,429726,1660,1629410)
