png("/rds/user/is460/hpc-work/muscle-rnaseq/ezbamqc/output/figs/srpk3_wt_ttnb_wt_6.read_distr.png",width=500,height=500,units="px")
M=c(16178545,375330,3614514,1699225,83032,578329,2240,2191843)
