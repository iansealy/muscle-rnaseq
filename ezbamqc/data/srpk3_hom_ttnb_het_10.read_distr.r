png("/rds/user/is460/hpc-work/muscle-rnaseq/ezbamqc/output/figs/srpk3_hom_ttnb_het_10.read_distr.png",width=500,height=500,units="px")
M=c(11797505,266744,2578370,1206920,59302,406205,1414,1535446)
