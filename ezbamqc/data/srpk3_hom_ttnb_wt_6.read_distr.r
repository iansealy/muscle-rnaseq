png("/rds/user/is460/hpc-work/muscle-rnaseq/ezbamqc/output/figs/srpk3_hom_ttnb_wt_6.read_distr.png",width=500,height=500,units="px")
M=c(15492212,355402,3506870,1601215,81451,554365,1993,2115036)
